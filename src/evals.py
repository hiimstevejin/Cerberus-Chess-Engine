...
# referenced this PeSTO's Evaluation Function
...
# multiplying two shifts bits to the left
# ex) Knight is 01 in binary 1*2 = 2 is 010 in binary first bit is reserved for color
...
# Game Phase Increments PAWN, KNIGHT, BISHOP, ROOK, QUEEN, KING
phase_inc = [0, 1, 1, 2, 4, 0]

# RAW PSQT DATA white side
mg_pawn_table = [
    0, 0, 0, 0, 0, 0, 0, 0,
